...
public class ServicesLocator {
	 ...
	 * 
	 * @param jndiName
	 *            nom JNDI du composant EJB recherché
	 * @return le stub du composant EJB correspondant au nom JNDI.
	 * @throws ServiceLocatorException
	 *             levé en cas de problèmes liés à la recherche.
	 */
	public Object getRemoteInterface(String nomEJB)
			throws ServicesLocatorException {
		// Le nom JNDI pour la récupération du service distant (stub du
		// composant EJB) est de la forme :
		// java:global/<nom projet EAR>/<nom sous-projet EJB>/<nom bean session
		// EJB>!<nom complet avec package de l'interface remote du bean>
		// Exemple :
		...
		// ils ne sont normalement pas appelés par la couche IHM.
			...
			nomJNDI = "java:global/CabinetRecrutement/CabinetRecrutement_EJB/NiveauQualificationDAO";
		...
		else if (nomEJB.equals("IServiceRemoteBean"))
			nomJNDI = " java:global/CabinetRecrutement/CabinetRecrutement_EJB/ServiceRemoteBean!eu.telecom_bretagne.cabinet_recrutement.service.IServiceRemoteBean";

		else
			throw new ServicesLocatorException(
					"Il n'y a pas d'EJB avec ce nom...");
