...
<h2>Mise à jour de l'entreprise</h2>
    	...
    	<input type="hidden" name="action" value="maj_entreprise" />
	  	<table id="affichage">
	  		...
	  		<tr>
		        ...
		        <td><input type="text" name="nom" size="20" maxlength="50" required></td>
	  	  	</tr>
	  	  	
	      	<tr>
          		<th>Descriptif :</th>
	        	<td><textarea rows="7" cols="70" name="descriptif" required></textarea></td>
	      	</tr>
	      	
	      	<tr>
          		<th>Adresse postale (ville) :</th>
	        	<td><input type="text" name="adresse_postale" size="20" maxlength="30" required></td>
	      	</tr>
...
<%
		...
		if(nom.equals(""))
		{%>
			<p class="erreur">Impossible de mettre à jour une entreprise sans saisir le nom</p>
		<%}
    ...
    Entreprise entreprise = serviceEntreprise.updateEntreprise(id, nom, descriptif, adressePostale);
